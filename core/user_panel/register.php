  ...
  //if form has been submitted process it
  						if(isset($_POST['submit'])){
  							...
  							if(!isset($error)){
  								...
  								try {
  									...
  									$stmt = $db->prepare('INSERT INTO members (username,password,email,active,avatar,time) VALUES (:username, :password, :email, :active, :avatar, :time)');
  									$stmt->execute(array(
  										':username' => $username,
                    ...
                    $messageregister = '
                      ...
                      ';
  									...
  									mail($to,$subject,$messageregister,$headers);

  									//redirect to index page
  									header('Location: index?action=joined');
  									exit;
                ...
                $error2[] = '<div class="alert alert-info" role="alert">'.$error.'</div>';
                $smarty->assign("loginerrorecho", $error2);
  						}
  					}
